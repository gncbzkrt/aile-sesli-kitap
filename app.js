const APP_VERSION="6.1.0-YUZDE100-TURKCE";
...
const ADULT_SUMMARIES=[{"id": "come-together", "title": "Come Together", "author": "Emily Nagoski", "year": 2024, "category": "Yakınlık", "cover": "c4", "summary": "Emily Nagoski, uzun ilişkilerde iyi bir cinsel yaşamın sürekli yüksek arzuya sahip olmakla değil, iki kişinin güvenli ve baskısız bir bağlam kurmasıyla ilgili olduğunu anlatır. Arzunun herkeste aynı şekilde başlamadığını; bazı insanlarda yakınlık başladıktan sonra ortaya çıktığını vurgular. Stres, yorgunluk, beden algısı, günlük sorumluluklar ve ilişki güvenliği arzuyu doğrudan etkileyebilir.\n\nKitabın ana fikri “normal miyiz?” sorusunu bırakıp “bizim için hangi koşullar işe yarıyor?” sorusuna geçmektir. Performans hedefi arttıkça kişi bedenini değerlendirmeye başlar ve haz azalabilir. Bu nedenle sonuç baskısını azaltmak, açıkça konuşmak, fikrini değiştirmeyi doğal kabul etmek ve karşılıklı rızayı merkeze koymak önemlidir.\n\nNagoski ayrıca uzun ilişkilerde yeniliğin yalnız farklı teknikler anlamına gelmediğini söyler. Partneri tekrar merak etmek, gündelik rollerin dışında görmek ve ilişkiye bilinçli zaman ayırmak da erotik canlılığı artırabilir. Kitabın uygulanabilir sonucu şudur: arzu zorlanmaz; uygun bağlam yaratıldığında daha kolay ortaya çıkar."}, {"id": "fight-right", "title": "Fight Right", "author": "John Gottman & Julie Schwartz Gottman", "year": 2024, "category": "İlişkiler", "cover": "c8", "summary": "Fight Right, sağlıklı ilişkilerin çatışmasız olmadığını; asıl farkın çatışmanın nasıl yönetildiğinde olduğunu anlatır. Birçok çift para, aile, ev işleri, zaman veya yakınlık gibi aynı konuları tekrar tekrar tartışır. Çünkü bazı anlaşmazlıkların altında kişilik ve değer farkları vardır.\n\nGottman yaklaşımı sert başlangıçların ilişkiye zarar verdiğini gösterir. “Sen zaten hiç…” gibi suçlayıcı ifadeler yerine kişinin kendi duygusunu ve ihtiyacını anlatması daha işlevseldir. Eleştiri, küçümseme, savunmacılık ve duvar örmenin yerine belirli davranışı konuşmak, kendi payını kabul etmek ve gerektiğinde kısa mola vermek önerilir.\n\nKitabın güçlü fikirlerinden biri, çatışmanın altında yatan hayali bulmaktır. Tasarruf tartışmasının altında güvenlik, seyahat isteğinin altında özgürlük olabilir. Amaç partneri yenmek değil, ikisinin de değerlerini görebilecek bir yol bulmaktır. İyi çiftler kırılma sonrası onarım yapar; “yeniden başlayabilir miyiz?” gibi küçük cümleler bile ilişkinin yönünü değiştirebilir."}, {"id": "love-life", "title": "Love Life", "author": "Matthew Hussey", "year": 2024, "category": "İlişkiler", "cover": "c1", "summary": "Love Life, romantik ilişki ararken kişinin bütün hayatını partner bulma projesine çevirmemesi gerektiğini savunur. Yüksek standartlarla duygusal açıklığın aynı anda mümkün olduğunu söyler. Yalnız kalma korkusuyla belirsiz ilişkilere fazla yatırım yapmak da, incinmemek için kimseye yaklaşmamak da sağlıklı değildir.\n\nHussey “potansiyele âşık olmak” konusunda uyarır. Bir insanın gelecekte nasıl biri olabileceği yerine bugün nasıl davrandığına bakmak gerekir. Tutarlılık, güvenilirlik ve karşılıklı emek romantik sözlerden daha değerlidir. “Beni ister mi?” sorusunun yanında “ben bu kişinin yanında nasıl hissediyorum?” sorusu da sorulmalıdır.\n\nKitap reddedilmeyi kişisel değer ölçüsü olmaktan çıkarmaya çalışır. Uyum olmaması değersizlik değildir. Arkadaşlık, iş, hobiler ve sağlık alanı güçlü oldukça kişi ilişkiye bütün ihtiyaçlarını karşılayacak tek kaynak gibi sarılmaz. Sevgi, özsaygının yerine geçmemeli; onunla birlikte var olmalıdır."}, {"id": "come-as-you-are", "title": "Come as You Are", "author": "Emily Nagoski", "year": 2021, "category": "Cinsellik", "cover": "c5", "summary": "Come as You Are, özellikle kadın cinselliğini bilimsel ve yargılamayan bir çerçevede ele alır. Nagoski, insanların cinsel tepkilerinin geniş bir normal aralıkta değiştiğini vurgular. Herkes aynı sıklıkta, aynı biçimde veya aynı koşullarda arzu hissetmez.\n\nKitabın en bilinen modeli “gaz ve fren” sistemidir. Uyarılmayı destekleyen etkenler gaz, stres, korku, güvensizlik, beden kaygısı ve yorgunluk ise fren gibi çalışabilir. Gaz güçlü olsa bile frenler devredeyse istek ortaya çıkmayabilir. Bu, problemi kişilik kusuru olarak görmek yerine bağlamı incelemeyi sağlar.\n\nBedenin otomatik tepkisi ile bilinçli istek aynı şey değildir; rıza her zaman kişinin açık isteğine dayanır. Nagoski ayrıca beden algısı ve stresin önemini anlatır. Daha iyi bir cinsel yaşam için ilk adım başkalarının standardına yetişmek değil, kendi sisteminin nasıl çalıştığını anlamaktır."}, {"id": "mating-in-captivity", "title": "Mating in Captivity", "author": "Esther Perel", "year": 2006, "category": "Yakınlık", "cover": "c7", "summary": "Esther Perel, uzun ilişkilerde güvenlik ile erotik canlılık arasında doğal bir gerilim olduğunu anlatır. İlişki yakınlık ve öngörülebilirlik sağlar; arzu ise çoğu zaman biraz merak, bireysellik ve yenilikten beslenir.\n\nPartneri yalnız eş, ebeveyn, ev arkadaşı veya sorumluluk ortağı olarak görmeye başlamak erotik merakı azaltabilir. Perel’e göre iki kişinin ayrı bireyler olarak kalması ilişki için tehdit değildir; aksine partneri yeniden ilginç ve canlı görmeye yardımcı olabilir.\n\nKitap planlanmış yakınlığın romantizmi öldürdüğü fikrine de itiraz eder. Yoğun yetişkin hayatında ilişkiye bilinçli zaman ayırmak önemlidir. Fanteziler davranış planı değildir; kişinin arzusu hakkında bilgi verebilir. Temel sınırlar her zaman karşılıklı rıza ve güvenliktir."}, {"id": "attached", "title": "Attached", "author": "Amir Levine & Rachel Heller", "year": 2010, "category": "Psikoloji", "cover": "c2", "summary": "Attached, yetişkin ilişkilerini bağlanma kuramı üzerinden açıklar: güvenli, kaygılı ve kaçıngan örüntüler. Bunlar kesin kişilik etiketleri değil, tekrar eden ilişki davranışlarını anlamak için kullanılan çerçevelerdir.\n\nKaygılı örüntüde belirsizlik ve mesafe daha hızlı alarm yaratabilir. Kaçıngan örüntüde yakınlık arttığında bağımsızlığın kaybolacağı hissi oluşabilir. Kaygılı-kaçıngan eşleşmede biri yaklaştıkça diğerinin uzaklaşması, iki tarafın da korkularını besleyen bir döngü yaratabilir.\n\nKitap açık iletişimi önerir. İma etmek veya karşı tarafın zihnini okumasını beklemek yerine ihtiyaçları doğrudan söylemek daha sağlıklıdır. Partner seçiminde yalnız yoğun kimyaya değil, tutarlılık ve erişilebilirliğe bakmak önemlidir. Bağlanma tarzları kader değildir; insanlar daha güvenli davranışlar öğrenebilir."}, {"id": "hold-me-tight", "title": "Hold Me Tight", "author": "Sue Johnson", "year": 2008, "category": "İlişkiler", "cover": "c3", "summary": "Sue Johnson’a göre çift tartışmalarının altında çoğu zaman “Benim için orada mısın?” sorusu vardır. Para, ev işleri veya yakınlık hakkındaki kavga; görülmeme, reddedilme veya terk edilme korkusunun dışa vurumu olabilir.\n\nKitap takip etme–geri çekilme döngüsünü anlatır. Bir taraf bağlantı kurmak için baskıyı artırır, diğeri baskıdan kaçmak için uzaklaşır. Uzaklaşma ilk tarafın kaygısını artırır ve döngü güçlenir. Hedef kimin haklı olduğunu bulmak değil, döngüyü ortak düşman olarak görmektir.\n\nDuygusal erişilebilirlik ve karşılık verme önemlidir. Partnerin her problemi çözmesi gerekmez; kişinin duygusunun duyulduğunu hissetmesi çoğu zaman yeterlidir. Güçlü ilişki hiç yara almayan değil, kopuştan sonra yeniden bağlantı kurulabilen ilişkidir."}, {"id": "eight-dates", "title": "Eight Dates", "author": "John Gottman, Julie Schwartz Gottman ve diğerleri", "year": 2019, "category": "İlişkiler", "cover": "c6", "summary": "Eight Dates, çiftlerin önemli konuları tesadüfe bırakmadan konuşabilmesi için sekiz yapılandırılmış buluşma önerir. Güven, çatışma, cinsellik ve yakınlık, iş ve para, aile, eğlence, gelişim ve hayaller gibi başlıklar ele alınır.\n\nKitabın temel varsayımı, insanların zaman içinde değiştiğidir. Yıllardır birlikte olmak, partnerin bugünkü düşüncelerini otomatik olarak bildiğimiz anlamına gelmez. Düzenli merak ilişkinin önemli bir parçasıdır.\n\nPara yalnız bütçe değil; güvenlik, özgürlük veya statü anlamına gelebilir. Yakınlık da yalnız sıklık değildir; sevilme, istenme ve güven duygusuyla ilgilidir. Amaç ikna etmekten çok anlamaktır. İyi ilişkiler büyük jestlerden çok düzenli ve dürüst konuşmalarla beslenir."}, {"id": "state-of-affairs", "title": "The State of Affairs", "author": "Esther Perel", "year": 2017, "category": "İlişkiler", "cover": "c8", "summary": "The State of Affairs, sadakatsizliği anlamaya çalışmanın onu onaylamak anlamına gelmediğini vurgular. Esther Perel, aldatmanın ciddi bir güven ihlali olduğunu kabul eder; fakat her olayın aynı nedenle gerçekleşmediğini anlatır.\n\nBazı durumlarda sadakatsizlik uzun süredir çözülemeyen ilişki sorunlarıyla bağlantılıdır; bazen kişi kendi kaybettiği bir benlik parçasını arıyor olabilir. Aldatma sonrasında ilk aşama güvenlik ve gerçeklik hissini yeniden kurmaktır. Belirsizliği azaltmak, sorumluluk almak ve yarayı küçümsememek önemlidir.\n\nDevam etmeyi seçen çiftlerin “eski ilişkiye dönmek” yerine yeni bir ilişki kurması gerekebilir. Dijital çağda sadakat sınırları da daha karmaşıktır; çiftlerin neyi ihlal olarak gördüğünü açıkça konuşması gerekir. Güven yeniden kurulabilir, ancak uzun süreli dürüstlük ve emek ister."}, {"id": "better-sex-mindfulness", "title": "Better Sex Through Mindfulness", "author": "Lori Brotto", "year": 2018, "category": "Cinsellik", "cover": "c5", "summary": "Lori Brotto, cinsel iyi oluş ile dikkat becerileri arasındaki ilişkiyi ele alır. Zihin sürekli performans, beden görünümü veya başarısızlık düşünceleriyle meşgulse bedensel duyumlara erişmek zorlaşabilir.\n\nMindfulness zihni boşaltmak değil, o anda olanı yargılamadan fark etmektir. Nefes, temas, sıcaklık ve duygusal yakınlık gibi duyumlara geri dönmek performans hedefinden uzaklaşmaya yardımcı olabilir. Bu yaklaşım özellikle stres ve beden algısı sorunlarında yararlı olabilir.\n\nKitap arzunun her zaman başlangıçta güçlü olmak zorunda olmadığını da vurgular. Güvenli bir bağlamda yakınlık sırasında arzu gelişebilir. Daha iyi cinsel yaşam yalnız teknik bilgi değil, dikkat, bedenle bağlantı ve açık iletişimle de ilgilidir."}, {"id": "seven-principles", "title": "The Seven Principles for Making Marriage Work", "author": "John Gottman & Nan Silver", "year": 2015, "category": "İlişkiler", "cover": "c2", "summary": "Gottman’ın yedi ilkesi, sağlam ilişkilerin günlük küçük davranışlarla kurulduğunu anlatır. Partnerin dünyasını merak etmek, sevgi ve hayranlığı canlı tutmak ve küçük bağlantı çağrılarına cevap vermek temel alışkanlıklardır.\n\nÇatışmada her sorunun çözülemeyeceği kabul edilir. Bazı farklılıklar kişilik ve değerlerle ilgilidir. Amaç partneri değiştirmek yerine yönetilebilir uzlaşma geliştirmek ve kilitlenmiş konuların altında yatan hayalleri anlamaktır.\n\nOrtak ritüeller, aile kültürü ve çiftin “biz kimiz?” sorusuna verdiği cevap ilişkiye anlam kazandırır. Kitabın ana mesajı, uzun ilişkilerin büyük romantik jestlerden çok merak, saygı ve onarım kapasitesiyle güçlendiğidir."}, {"id": "all-about-love", "title": "All About Love", "author": "bell hooks", "year": 2000, "category": "Yakınlık", "cover": "c4", "summary": "bell hooks sevgiyi yalnız romantik bir duygu değil, bakım, saygı, sorumluluk, güven ve dürüstlük içeren bir pratik olarak ele alır. “Seni seviyorum” demek, sevgi davranışı olmadan yeterli değildir.\n\nÇocukluk deneyimleri yetişkinlikte sevgi anlayışını etkileyebilir. Sevgi ile kontrol veya sevgi ile korku birbirine karıştıysa kişi sağlıksız davranışları normal sanabilir. Özsevgi bencillik değildir; kişinin kendi değerini yalnız partnerin onayına bağlamamasına yardımcı olur.\n\nKitap romantik aşkı hayatın tek sevgi biçimi olarak görmez. Arkadaşlık, aile ve topluluk bağları da önemlidir. Ana mesaj şudur: sevgi yalnız başımıza gelen bir his değil, tekrar tekrar seçilen bir eylemdir."}];
...
let adultCategory="Tümü",adultUnlocked=false;
...
async function init(){
  ...
  bind();renderCatalog();renderReadyBooks();renderAll();renderKitupHome();initVoices();updateRateLabels();renderSourceStats();loadArchive(false);primeSourceCounts();initAdultSection();
...
function bind(){
  ...
  $("#adultUnlockBtn").onclick=()=>openModal("#adultConfirmModal");
  $("#adultConfirmBtn").onclick=confirmAdultAccess;
  $("#adultLockBtn").onclick=lockAdultSection;
...
async function addTtsCatalogBook(x){
  ...
  try{
    ...
    if(text.length<400)throw new Error("Metin çok kısa");if(!isTurkishText(text))throw new Error("Metin Türkçe değil");
...
async function importTextBook(){
  ...
  try{
    ...
    if(text.length<150)throw new Error("Okunabilir metin bulunamadı");if(!isTurkishText(text))throw new Error("Yalnız Türkçe kitaplar destekleniyor");
    const parts=splitBookText(text),chs=[];
...
async function initVoices(){
  ...
  const fill=async()=>{voices=speechSynthesis.getVoices();const tr=voices.filter(v=>/^tr([-_]|$)/i.test(v.lang));const list=tr;const saved=(await getOne(SETTINGS,"ttsVoice"))?.value;$("#voiceSelect").innerHTML=list.map(v=>`<option value="${esc(v.name)}" ${v.name===saved?"selected":""}>${esc(v.name)} (${esc(v.lang)})${v.default?" · varsayılan":""}</option>`).join("")||"<option>Ses bulunamadı</option>"};
  await fill();speechSynthesis.onvoiceschanged=fill;
}
function selectedVoice(){return voices.find(v=>v.name===$("#voiceSelect").value)||voices.find(v=>/^tr([-_]|$)/i.test(v.lang))||null}
function startTts(){
...
function testVoice(){if(!("speechSynthesis"in window))return toast("Bu cihaz TTS desteklemiyor.");speechSynthesis.cancel();const u=new SpeechSynthesisUtterance("Merhaba. Sesli Kitaplık için seçtiğin Türkçe ses bu şekilde duyulacak.");u.lang="tr-TR";u.rate=+$("#rateRange").value;u.pitch=+$("#pitchRange").value;const v=selectedVoice();if(!v)return toast("Bu cihazda Türkçe TTS sesi bulunamadı.");u.voice=v;speechSynthesis.speak(u)}
...
async function initAdultSection(){
  const s=await getOne(SETTINGS,"adultUnlocked");
  adultUnlocked=!!s?.value;
  renderAdultSection();
}
function renderAdultSection(){
  $("#adultLocked").classList.toggle("hidden",adultUnlocked);
  $("#adultContent").classList.toggle("hidden",!adultUnlocked);
  $("#adultUnlockBtn").textContent=adultUnlocked?"18+ Açık ✓":"18+ Bölümünü Aç";
  if(!adultUnlocked)return;
  const cats=["Tümü",...new Set(ADULT_SUMMARIES.map(x=>x.category))];
  $("#adultChips").innerHTML=cats.map(c=>`<button class="chip ${c===adultCategory?"active":""}" data-adult-cat="${esc(c)}">${esc(c)}</button>`).join("");
  $$("[data-adult-cat]").forEach(b=>b.onclick=()=>{adultCategory=b.dataset.adultCat;renderAdultSection()});
  const list=ADULT_SUMMARIES.filter(x=>adultCategory==="Tümü"||x.category===adultCategory);
  $("#adultRail").innerHTML=list.map(x=>{
    const words=x.summary.trim().split(/\s+/).length;
    const mins=Math.max(3,Math.round(words/135));
    return `<article class="catalog-card adult-card">
      <button class="cover-card" data-adult-book="${x.id}">
        <div class="book-cover ${x.cover}">
          <span class="cover-mark">ÖZET</span><span class="adult-badge">18+</span>
          <div class="cover-title">${esc(x.title)}</div>
        </div>
        <div class="card-title">${esc(x.title)}</div>
        <div class="card-author">${esc(x.author)} · ${x.year}</div>
        <div class="adult-summary-note">🎧 ~${mins} dk Türkçe özet</div>
      </button>
    </article>`;
  }).join("");
  $$("[data-adult-book]").forEach(b=>b.onclick=()=>playAdultSummary(b.dataset.adultBook));
}
async function confirmAdultAccess(){
  if(!$("#adultConfirmCheck").checked)return toast("Devam etmek için 18+ onayını işaretle.");
  adultUnlocked=true;
  await put(SETTINGS,{key:"adultUnlocked",value:true});
  closeOverlays();renderAdultSection();$("#adultSection").scrollIntoView({behavior:"smooth"});toast("18+ bölümü açıldı.");
}
async function lockAdultSection(){
  adultUnlocked=false;adultCategory="Tümü";
  await put(SETTINGS,{key:"adultUnlocked",value:false});
  renderAdultSection();closeOverlays();toast("18+ bölümü kilitlendi.");
}
async function playAdultSummary(id){
  if(!adultUnlocked)return openModal("#adultConfirmModal");
  const x=ADULT_SUMMARIES.find(v=>v.id===id);if(!x)return;
  closeOverlays();stopPlayback(false);
  currentBook={
    id:"adult-summary-"+x.id,title:x.title+" — Özet",author:x.author,genre:"18+ · "+x.category,
    coverClass:x.cover,source:"tts",isSummary:true,isAdult:true,
    chapters:[{id:"summary",title:"Türkçe Kitap Özeti",progress:0,segmentIndex:0}],
    currentChapter:0,bookmarks:[],history:[],favorite:false,lastPlayedAt:Date.now()
  };
  currentChapter=0;
  $("#playerBigCover").className=`player-big-cover ${x.cover}`;
  $("#playerBigCover").style.backgroundImage="";
  $("#playerBigCover").innerHTML=`<span class="adult-badge">18+</span><div class="cover-title">${esc(x.title)}<br><small>ÖZET</small></div>`;
  $("#playerTitle").textContent=x.title+" — Türkçe Özet";
  $("#playerAuthor").textContent=x.author;
  $("#playerMode").textContent="18+ · "+x.category.toUpperCase()+" · TÜRKÇE TTS";
  $("#playerChapter").textContent="Ana fikirler · uygulanabilir çıkarımlar";
  $("#favBtn").textContent="♡ Favori";
  tts.segments=segmentText(x.summary);tts.segmentIndex=0;tts.playing=false;
...
function renderSourceStats(){
  ...
  $("#sourceStats").innerHTML=`
    ...
    <div class="source-stat"><strong>+ açık ağ</strong><span>Açık Kitaplık · Gutenberg</span></div>`;
}
...
const TURKISH_COMMON_WORDS=new Set(["ve","bir","bu","da","de","ile","için","ama","gibi","çok","daha","olan","olarak","ise","ne","o","şu","ben","sen","biz","siz","onlar","var","yok","mi","mı","mu","mü","ki","hem","ya","sonra","önce","kadar","çünkü","ancak","fakat","her","bütün","insan","hayat","zaman","şey","kendi","bile","artık","nasıl","neden","oldu","olur","olmak","etmek","etti","diye"]);
function turkishLanguageScore(text){
  const s=String(text||"").toLocaleLowerCase("tr");
  const words=s.match(/[a-zçğıöşüâîû]+/g)||[]; if(words.length<30)return 0;
  let common=0,turkChars=0; for(const w of words){if(TURKISH_COMMON_WORDS.has(w))common++;if(/[çğıöşü]/.test(w))turkChars++;}
  return (common/words.length)*0.75+(turkChars/words.length)*0.25;
}
function isTurkishText(text){const s=String(text||"");if(s.length<250)return false;return turkishLanguageScore(s.slice(0,12000))>=0.018;}
function looksTurkishTitle(title){
  const t=String(title||"").trim();if(!t)return false;if(/[çğıöşüİ]/.test(t))return true;
  const n=normalizeFilterText(t);const hints=["bir","ve","ile","icin","uzerine","hayat","ask","sevgi","insan","gece","gun","yol","ev","cocuk","hikaye","roman","siir","mektup","hatira","turk","istanbul","anadolu","kadin","erkek"];
...
async function globalSourceSearch(){
  ...
  // Açık Kitaplık: only Turkish + public ebook access. Low-volume search only.
  try{
    ...
    const j=await (await fetch(u,{cache:"no-store"})).json();
    (j.docs||[]).filter(x=>x.has_fulltext&&x.ia?.length&&isLikelyBookTitle(x.title)&&looksTurkishTitle(x.title)).forEach(x=>rows.push({
      source:"Açık Kitaplık",kind:"openlibrary",title:x.title,author:(x.author_name||[]).join(", ")||"Bilinmeyen yazar",
      ia:x.ia[0],year:x.first_publish_year||"",publicScan:!!x.public_scan_b
    }));
  }catch(e){console.warn("Açık Kitaplık arama",e)}
  // Gutenberg Projesi via Gutendex: Turkish-language only.
  try{
    const u="https://gutendex.com/books?"+new URLSearchParams({languages:"tr",search:q});
    const j=await (await fetch(u,{cache:"no-store"})).json();
    (j.results||[]).filter(x=>isLikelyBookTitle(x.title)&&looksTurkishTitle(x.title)).slice(0,20).forEach(x=>rows.push({
      source:"Gutenberg Projesi",kind:"gutenberg",title:x.title,author:(x.authors||[]).map(a=>a.name).join(", ")||"Bilinmeyen yazar",
      gutenberg:x
    }));
...
async function importOpenLibraryItem(r){
  ...
  try{
    ...
    const text=normalizeBookText(await resp.text());if(text.length<300)throw new Error("Metin kısa");if(!isTurkishText(text))throw new Error("Metin Türkçe değil");
    await createImportedTextBook({title:r.title,author:r.author,genre:"Açık Kitaplık",text,format:"open",filename:r.ia});
  }catch(e){console.error(e);toast("Bu Açık Kitaplık kaydının okunabilir metni alınamadı.")}
  finally{loading(false)}
}
async function importGutenbergItem(g){
  ...
  try{
    ...
    if(text.length<300)throw new Error("Metin kısa");if(!isTurkishText(text))throw new Error("Metin Türkçe değil");
    const author=(g.authors||[]).map(a=>a.name).join(", ")||"Bilinmeyen yazar";
    await createImportedTextBook({title:g.title,author,genre:"Gutenberg Projesi",text,format:"gutenberg",filename:String(g.id)});
...
function showSourceStatus(){
  ...
  $("#listModalBody").innerHTML=`
    ...
    <div class="list-item"><div><strong>Açık Kitaplık</strong><div class="meta">${v(sourceCounts.openLibrary)} Türkçe public/open sonuç · arama bazlı erişim</div></div></div>
    <div class="list-item"><div><strong>Gutenberg Projesi</strong><div class="meta">${v(sourceCounts.gutenberg)} Türkçe katalog sonucu · varsa doğrudan metin</div></div></div>
    <div class="list-item"><div><strong>Kendi Dosyaların</strong><div class="meta">EPUB · PDF · TXT · MP3/M4A · tamamen cihaz içi</div></div></div>
    <p class="source-note">v5.0 LTS TÜRKÇE: kaynak mimarisi sabitlendi. Dinamik kaynakların sonuç sayıları zamanla değişebilir.</p>`;
  openModal("#listModal");
}
...
const NON_BOOK_SUBSTRINGS=[
  "iddianame","sorusturma","kovusturma","supheli","sanik","mahkeme","yargitay","danistay",
  "anayasa mahkemesi","savcilik","bilirkişi","bilirkisi","tutanak","resmi gazete","resmî gazete",
  "yonetmelik","yönetmelik","teblig","tebliğ","genelge","kararname","mevzuat","dilekce","dilekçe",
  "evrak","protokol","komisyon raporu","esas no","karar no","ceza dosyasi","ceza dosyası",
  "sorusturma evraki","soruşturma evrakı","bireysel durumlari","bireysel durumları"
];
...
function looksLikeDocumentTitle(title){
  ...
  const n=normalizeFilterText(t);
  if(NON_BOOK_SUBSTRINGS.some(x=>n.includes(normalizeFilterText(x))))return true;
  if(NON_BOOK_PATTERNS.some(rx=>rx.test(t)))return true;

  // Strong compound checks for structured legal/document titles.
  if(n.includes("ergenekon") && (n.includes("bolum") || n.includes("teror orgutu") || n.includes("eylemler")))return true;
  if(n.includes("bolum") && (n.includes("supheli") || n.includes("sorusturma") || n.includes("evrak")))return true;
...
async function loadArchive(force){
  ...
  try{
    const key="archive-v2-"+archiveMode;
...
async function addArchiveWork(title){
  ...
  try{
    ...
    if(text.length<120)throw new Error("Metin kısa");if(!isTurkishText(text))throw new Error("Metin Türkçe değil");
    const parts=splitBookText(text),chs=[];
    for(let i=0;i<parts.length;i++){
      const fid=uid();await put(FILES,{id:fid,type:"text",text:parts[i],size:new Blob([parts[i]]).size});
      chs.push({id:uid(),fileId:fid,title:`Bölüm ${i+1}`,order:i,segmentIndex:0,progress:0});
